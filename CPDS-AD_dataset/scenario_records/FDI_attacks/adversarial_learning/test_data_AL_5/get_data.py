...
attack_index_path = max(attack_index_candidates, key=lambda path: path.stat().st_mtime)
print(f"Using attack index: {attack_index_path.name}")
FDI_index = np.load(attack_index_path)
